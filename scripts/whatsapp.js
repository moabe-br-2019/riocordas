(function() {
    ...
    function criarBotaoWhatsApp() {
        ...
        const numeroWhatsApp = "5521975525707"; // Substitua pelo seu número
        const mensagem = "Olá! Gostaria de mais informações sobre o grupo Rio cordas"; // Mensagem opcional
